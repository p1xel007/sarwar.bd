...
export default defineConfig({
  ...
  integrations: [
    ...
    AstroPWA({
      ...
      includeAssets: ["favicon.ico", "sarwar-avatar.jpg"],
      manifest: {
        name: "Sarwar Alam",
        short_name: "Sarwar Alam",
        description: "Full Stack Developer & Team Lead. Building lead distribution systems, SaaS platforms, and scalable web applications.",
        theme_color: "#006cac",
